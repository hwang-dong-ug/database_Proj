...
<h3 style="test-align: center;">관리자 메인페이지</h3>
    <div class="container">
        <div class="col-lg-4">
            ...
            <div class="jumbotron" style="padding-top: 20px;">
                <button type="button" class="btn btn-primary form-control" onClick="location.href='openCloseClass.jsp'">강좌 조회/개설/삭제</button>
            </div>
            <div class="jumbotron" style="padding-top: 20px;">
                <button type="button" class="btn btn-primary form-control" onClick="location.href='OLAP.jsp'">OLAP</button>
            </div>
